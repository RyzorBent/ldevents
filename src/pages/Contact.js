...
export default function ContactForm() {
  return (
    <div className={`${sections} bg-gray-700 mt-6 mb-16 p-6 text-white `}>
      ...
      >
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          <input
            ...
            className='border border-gray-100 text-white placeholder-gray-400 p-3 rounded-md'
            required
          />
          <input
            type='text'
            ...
            className='border border-gray-600 text-white placeholder-gray-400 p-3 rounded-md'
            required
          />
        </div>
        <input
        ...
        <div className='flex justify-between items-center mt-6'>
          <button
            type='submit'
            className='text-white py-2 px-4 rounded-md hover:bg-gray-600 transition duration-150 ease-in-out'
          >
            Send
          </button>
        </div>
